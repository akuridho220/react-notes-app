    ...
    return (
      <div className="note-input">
        ...
        <form onSubmit={this.onSubmitEventHandler}>
          ...
          <input className="note-input__title" type="text" placeholder="Silahkan masukkan judul ..." value={this.state.title} onChange={this.onTitleChangeEventHandler} required />
